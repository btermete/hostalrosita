            ...
            764: function(e) {
                e.exports = function() {
                    ...
                    const e = "SweetAlert2:",
                        ...
                        C = e => {
                            g.includes(e) && i('The parameter "'.concat(e, '" is incompatible with toasts'))
                        },
                        x = e => {
                            w(e) && l(e, w(e))
                        },
                        T = e => {
                            ...
                            for (const t in e) y(t), e.toast && C(t), x(t)
                        },
                        S = "swal2-",
                        E = e => {
                            const t = {};
                            for (const n in e) t[e[n]] = S + e[n];
                            return t
                        },
                        ...
                        O = () => document.body.querySelector(".".concat(k.container)),
                        A = e => {
                            const t = O();
                        ...
                        B = () => M(k.icon),
                        $ = () => M(k.title),
                        I = () => M(k["html-container"]),
                        j = () => M(k.image),
                        D = () => M(k["progress-steps"]),
                        z = () => M(k["validation-message"]),
                        _ = () => A(".".concat(k.actions, " .").concat(k.confirm)),
                        N = () => A(".".concat(k.actions, " .").concat(k.deny)),
                        H = () => M(k["input-label"]),
                        q = () => A(".".concat(k.loader)),
                        G = () => A(".".concat(k.actions, " .").concat(k.cancel)),
                        V = () => M(k.actions),
                        F = () => M(k.footer),
                        W = () => M(k["timer-progress-bar"]),
                        R = () => M(k.close),
                        Y = '\n  a[href],\n  area[href],\n  input:not([disabled]),\n  select:not([disabled]),\n  textarea:not([disabled]),\n  button:not([disabled]),\n  iframe,\n  object,\n  embed,\n  [tabindex="0"],\n  [contenteditable],\n  audio[controls],\n  video[controls],\n  summary\n',
                        X = () => {
                            const e = s(L().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(((e, t) => {
                                    const n = parseInt(e.getAttribute("tabindex")),
                                        s = parseInt(t.getAttribute("tabindex"));
                                    return n > s ? 1 : n < s ? -1 : 0
                                })),
                                n = s(L().querySelectorAll(Y)).filter((e => "-1" !== e.getAttribute("tabindex")));
                            return t(e.concat(n)).filter((e => he(e)))
                        },
                        U = () => ee(document.body, k.shown) && !ee(document.body, k["toast-shown"]) && !ee(document.body, k["no-backdrop"]),
                        K = () => L() && ee(L(), k.toast),
                        Z = () => L().hasAttribute("data-loading"),
                        J = {
                        ...
                        Q = (e, t) => {
                            if (e.textContent = "", t) {
                                ...
                                s(n.querySelector("head").childNodes).forEach((t => {
                                    e.appendChild(t)
                                })), s(n.querySelector("body").childNodes).forEach((t => {
                                    e.appendChild(t)
                                }))
                            }
                        },
                        ...
                        te = (e, t) => {
                            s(e.classList).forEach((n => {
                                Object.values(k).includes(n) || Object.values(P).includes(n) || Object.values(t.showClass).includes(n) || e.classList.remove(n)
                            }))
                        },
                        ne = (e, t, n) => {
                        ...
                        se = (e, t) => {
                            ...
                            switch (t) {
                                ...
                                case "textarea":
                                case "file":
                                    return e.querySelector(".".concat(k.popup, " > .").concat(k[t]));
                                case "checkbox":
                                    return e.querySelector(".".concat(k.popup, " > .").concat(k.checkbox, " input"));
                                case "radio":
                                    return e.querySelector(".".concat(k.popup, " > .").concat(k.radio, " input:checked")) || e.querySelector(".".concat(k.popup, " > .").concat(k.radio, " input:first-child"));
                                case "range":
                                    return e.querySelector(".".concat(k.popup, " > .").concat(k.range, " input"));
                                default:
                                    return e.querySelector(".".concat(k.popup, " > .").concat(k.input))
                            }
                        },
                        ie = e => {
                        ...
                        xe = {},
                        Te = () => {
                            xe.previousActiveElement && xe.previousActiveElement.focus ? (xe.previousActiveElement.focus(), xe.previousActiveElement = null) : document.body && document.body.focus()
                        },
                        Se = e => new Promise((t => {
                            if (!e) return t();
                            const n = window.scrollX,
                                s = window.scrollY;
                            xe.restoreFocusTimeout = setTimeout((() => {
                                Te(), t()
                            }), Ce), window.scrollTo(n, s)
                        })),
                        ...
                        ke = () => {
                            const e = O();
                            return !!e && (e.remove(), ae([document.documentElement, document.body], [k["no-backdrop"], k["toast-shown"], k["has-column"]]), !0)
                        },
                        Pe = () => {
                        ...
                        Oe = () => {
                            const e = L(),
                                t = le(e, k.input),
                                n = le(e, k.file),
                                s = e.querySelector(".".concat(k.range, " input")),
                                i = e.querySelector(".".concat(k.range, " output")),
                                r = le(e, k.select),
                                o = e.querySelector(".".concat(k.checkbox, " input")),
                                a = le(e, k.textarea);
                            t.oninput = Pe, n.onchange = Pe, r.onchange = Pe, o.onchange = Pe, a.oninput = Pe, s.oninput = () => {
                                Pe(), i.value = s.value
                            }, s.onchange = () => {
                                Pe(), s.nextSibling.value = s.value
                            }
                        },
                        Ae = e => "string" == typeof e ? document.querySelector(e) : e,
                        Me = e => {
                            const t = L();
                            t.setAttribute("role", e.toast ? "alert" : "dialog"), t.setAttribute("aria-live", e.toast ? "polite" : "assertive"), e.toast || t.setAttribute("aria-modal", "true")
                        },
                        Le = e => {
                            "rtl" === window.getComputedStyle(e).direction && oe(O(), k.rtl)
                        },
                        Be = e => {
                            const t = ke();
                            if (ye()) return void r("SweetAlert2 requires document to initialize");
                            const n = document.createElement("div");
                            n.className = k.container, t && oe(n, k["no-transition"]), Q(n, Ee);
                            const s = Ae(e.target);
                            s.appendChild(n), Me(e), Le(s), Oe()
                        },
                        $e = (e, t) => {
                            e instanceof HTMLElement ? t.appendChild(e) : "object" == typeof e ? Ie(e, t) : e && Q(t, e)
                        },
                        Ie = (e, t) => {
                        ...
                        _e = (e, t) => {
                            const n = V(),
                                s = q();
                            t.showConfirmButton || t.showDenyButton || t.showCancelButton ? de(n) : ue(n), ne(n, t, "actions"), Ne(n, s, t), Q(s, t.loaderHtml), ne(s, t, "loader")
                        };
                    ...
                    function Ne(e, t, n) {
                        const s = _(),
                            i = N(),
                            r = G();
                        qe(s, "confirm", n), qe(i, "deny", n), qe(r, "cancel", n), He(s, i, r, n), n.reverseButtons && (n.toast ? (e.insertBefore(r, s), e.insertBefore(i, s)) : (e.insertBefore(r, t), e.insertBefore(i, t), e.insertBefore(s, t)))
                    }

                    function He(e, t, n, s) {
                        if (!s.buttonsStyling) return ae([e, t, n], k.styled);
                        oe([e, t, n], k.styled), s.confirmButtonColor && (e.style.backgroundColor = s.confirmButtonColor, oe(e, k["default-outline"])), s.denyButtonColor && (t.style.backgroundColor = s.denyButtonColor, oe(t, k["default-outline"])), s.cancelButtonColor && (n.style.backgroundColor = s.cancelButtonColor, oe(n, k["default-outline"]))
                    }

                    function qe(e, t, s) {
                        me(e, s["show".concat(n(t), "Button")], "inline-block"), Q(e, s["".concat(t, "ButtonText")]), e.setAttribute("aria-label", s["".concat(t, "ButtonAriaLabel")]), e.className = k[t], ne(e, s, "".concat(t, "Button")), oe(e, s["".concat(t, "ButtonClass")])
                    }

                    function Ge(e, t) {
                        "string" == typeof t ? e.style.background = t : t || oe([document.documentElement, document.body], k["no-backdrop"])
                    }

                    function Ve(e, t) {
                        t in k ? oe(e, k[t]) : (i('The "position" parameter is not valid, defaulting to "center"'), oe(e, k.center))
                    }
                    ...
                    const We = (e, t) => {
                        const n = O();
                        n && (Ge(n, t.backdrop), Ve(n, t.position), Fe(n, t.grow), ne(n, t, "container"))
                    };
                    var Re = {
                    ...
                    const Ye = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
                        Xe = (e, t) => {
                            const n = L(),
                                s = Re.innerParams.get(e),
                                i = !s || t.input !== s.input;
                            Ye.forEach((e => {
                                const s = k[e],
                                    r = le(n, s);
                                Ze(e, t.inputAttributes), r.className = s, i && ue(r)
                            })), t.input && (i && Ue(t), Je(t))
                        },
                        Ue = e => {
                            if (!nt[e.input]) return r('Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "'.concat(e.input, '"'));
                            const t = tt(e.input),
                                n = nt[e.input](t, e);
                            de(n), setTimeout((() => {
                                ie(n)
                        ...
                        et = (e, t, n) => {
                            if (n.inputLabel) {
                                ...
                                const s = document.createElement("label"),
                                    i = k["input-label"];
                                s.setAttribute("for", e.id), s.className = i, oe(s, n.customClass.inputLabel), s.innerText = n.inputLabel, t.insertAdjacentElement("beforebegin", s)
                            }
                        },
                        tt = e => {
                            const t = k[e] ? k[e] : k.input;
                            return le(L(), t)
                        },
                        nt = {};
                    nt.text = nt.email = nt.password = nt.number = nt.tel = nt.url = (e, t) => ("string" == typeof t.inputValue || "number" == typeof t.inputValue ? e.value = t.inputValue : p(t.inputValue) || i('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof t.inputValue, '"')), et(e, e, t), Qe(e, t), e.type = t.input, e), nt.file = (e, t) => (et(e, e, t), Qe(e, t), e), nt.range = (e, t) => {
                        const n = e.querySelector("input"),
                            s = e.querySelector("output");
                        return n.value = t.inputValue, n.type = t.input, s.value = t.inputValue, et(n, e, t), e
                    }, nt.select = (e, t) => {
                    ...
                    const st = (e, t) => {
                            const n = I();
                            ne(n, t, "htmlContainer"), t.html ? ($e(t.html, n), de(n, "block")) : t.text ? (n.textContent = t.text, de(n, "block")) : ue(n), Xe(e, t)
                        },
                        it = (e, t) => {
                            const n = F();
                            me(n, t.footer), t.footer && $e(t.footer, n), ne(n, t, "footer")
                        },
                        rt = (e, t) => {
                            const n = R();
                        ...
                        ot = (e, t) => {
                            const n = Re.innerParams.get(e),
                                s = B();
                            return n && t.icon === n.icon ? (ut(s, t), void at(s, t)) : t.icon || t.iconHtml ? t.icon && -1 === Object.keys(P).indexOf(t.icon) ? (r('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(t.icon, '"')), ue(s)) : (de(s), ut(s, t), at(s, t), void oe(s, t.showClass.icon)) : ue(s)
                        },
                        at = (e, t) => {
                            for (const n in P) t.icon !== n && ae(e, P[n]);
                            oe(e, P[t.icon]), pt(e, t), lt(), ne(e, t, "icon")
                        },
                        lt = () => {
                            const e = L(),
                        ...
                        ut = (e, t) => {
                            e.textContent = "", t.iconHtml ? Q(e, mt(t.iconHtml)) : "success" === t.icon ? Q(e, ct) : "error" === t.icon ? Q(e, dt) : Q(e, mt({
                                question: "?",
                                warning: "!",
                                info: "i"
                            } [t.icon]))
                        ...
                        mt = e => '<div class="'.concat(k["icon-content"], '">').concat(e, "</div>"),
                        ht = (e, t) => {
                            const n = j();
                            if (!t.imageUrl) return ue(n);
                            de(n, ""), n.setAttribute("src", t.imageUrl), n.setAttribute("alt", t.imageAlt), ce(n, "width", t.imageWidth), ce(n, "height", t.imageHeight), n.className = k.image, ne(n, t, "image")
                        },
                        ft = e => {
                            const t = document.createElement("li");
                            return oe(t, k["progress-step"]), Q(t, e), t
                        },
                        gt = e => {
                            const t = document.createElement("li");
                            return oe(t, k["progress-step-line"]), e.progressStepsDistance && (t.style.width = e.progressStepsDistance), t
                        },
                        vt = (e, t) => {
                            const n = D();
                            if (!t.progressSteps || 0 === t.progressSteps.length) return ue(n);
                            de(n), n.textContent = "", t.currentProgressStep >= t.progressSteps.length && i("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), t.progressSteps.forEach(((e, s) => {
                                const i = ft(e);
                                if (n.appendChild(i), s === t.currentProgressStep && oe(i, k["active-progress-step"]), s !== t.progressSteps.length - 1) {
                                    const e = gt(t);
                                    n.appendChild(e)
                                }
                            }))
                        ...
                        bt = (e, t) => {
                            const n = $();
                            me(n, t.title || t.titleText, "block"), t.title && $e(t.title, n), t.titleText && (n.innerText = t.titleText), ne(n, t, "title")
                        },
                        wt = (e, t) => {
                            const n = O(),
                                s = L();
                            t.toast ? (ce(n, "width", t.width), s.style.width = "100%", s.insertBefore(q(), B())) : ce(s, "width", t.width), ce(s, "padding", t.padding), t.color && (s.style.color = t.color), t.background && (s.style.background = t.background), ue(z()), yt(s, t)
                        },
                        yt = (e, t) => {
                            e.className = "".concat(k.popup, " ").concat(he(e) ? t.showClass.popup : ""), t.toast ? (oe([document.documentElement, document.body], k["toast-shown"]), oe(e, k.toast)) : oe(e, k.modal), ne(e, t, "popup"), "string" == typeof t.customClass && oe(e, t.customClass), t.icon && oe(e, k["icon-".concat(t.icon)])
                        },
                        Ct = (e, t) => {
                            wt(e, t), We(e, t), vt(e, t), ot(e, t), ht(e, t), bt(e, t), rt(e, t), st(e, t), _e(e, t), it(e, t), "function" == typeof t.didRender && t.didRender(L())
                        },
                        xt = Object.freeze({
                            cancel: "cancel",
                            backdrop: "backdrop",
                        ...
                        kt = e => {
                            ...
                            if (!t) return {};
                            const n = t.content;
                            return $t(n), Object.assign(Pt(n), Ot(n), At(n), Mt(n), Lt(n), Bt(n, Et))
                        },
                        Pt = e => {
                            const t = {};
                            return s(e.querySelectorAll("swal-param")).forEach((e => {
                                ...
                                "boolean" == typeof m[n] && "false" === s && (t[n] = !1), "object" == typeof m[n] && (t[n] = JSON.parse(s))
                            })), t
                        },
                        Ot = e => {
                            const t = {};
                            return s(e.querySelectorAll("swal-button")).forEach((e => {
                                It(e, ["type", "color", "aria-label"]);
                                const s = e.getAttribute("type");
                                t["".concat(s, "ButtonText")] = e.innerHTML, t["show".concat(n(s), "Button")] = !0, e.hasAttribute("color") && (t["".concat(s, "ButtonColor")] = e.getAttribute("color")), e.hasAttribute("aria-label") && (t["".concat(s, "ButtonAriaLabel")] = e.getAttribute("aria-label"))
                            })), t
                        },
                        At = e => {
                            const t = {},
                                n = e.querySelector("swal-image");
                            return n && (It(n, ["src", "width", "height", "alt"]), n.hasAttribute("src") && (t.imageUrl = n.getAttribute("src")), n.hasAttribute("width") && (t.imageWidth = n.getAttribute("width")), n.hasAttribute("height") && (t.imageHeight = n.getAttribute("height")), n.hasAttribute("alt") && (t.imageAlt = n.getAttribute("alt"))), t
                        },
                        Mt = e => {
                            const t = {},
                                n = e.querySelector("swal-icon");
                            return n && (It(n, ["type", "color"]), n.hasAttribute("type") && (t.icon = n.getAttribute("type")), n.hasAttribute("color") && (t.iconColor = n.getAttribute("color")), t.iconHtml = n.innerHTML), t
                        },
                        Lt = e => {
                            const t = {},
                                n = e.querySelector("swal-input");
                            n && (It(n, ["type", "label", "placeholder", "value"]), t.input = n.getAttribute("type") || "text", n.hasAttribute("label") && (t.inputLabel = n.getAttribute("label")), n.hasAttribute("placeholder") && (t.inputPlaceholder = n.getAttribute("placeholder")), n.hasAttribute("value") && (t.inputValue = n.getAttribute("value")));
                            const i = e.querySelectorAll("swal-input-option");
                            return i.length && (t.inputOptions = {}, s(i).forEach((e => {
                                It(e, ["value"]);
                        ...
                        Bt = (e, t) => {
                            ...
                            for (const s in t) {
                                const i = t[s],
                                    r = e.querySelector(i);
                                r && (It(r, []), n[i.replace(/^swal-/, "")] = r.innerHTML.trim())
                            }
                            return n
                        },
                        $t = e => {
                    ...
                    function Dt(e) {
                        e.inputValidator || Object.keys(jt).forEach((t => {
                    ...
                    function _t(e) {
                        Dt(e), e.showLoaderOnConfirm && !e.preConfirm && i("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request"), zt(e), "string" == typeof e.title && (e.title = e.title.split("\n").join("<br />")), Be(e)
                    }
                    class Nt {
                        constructor(e, t) {
                    ...
                    const Ht = () => {
                        ...
                        Gt = () => {
                            if ((/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream || "MacIntel" === navigator.platform && navigator.maxTouchPoints > 1) && !ee(document.body, k.iosfix)) {
                                const e = document.body.scrollTop;
                                document.body.style.top = "".concat(-1 * e, "px"), oe(document.body, k.iosfix), Ft(), Vt()
                            }
                        },
                        Vt = () => {
                            ...
                            if (t && n && !e.match(/CriOS/i)) {
                                const e = 44;
                                L().scrollHeight > window.innerHeight - e && (O().style.paddingBottom = "".concat(e, "px"))
                            }
                        },
                        Ft = () => {
                            const e = O();
                        ...
                        Wt = e => {
                            const t = e.target,
                                n = O();
                            return !(Rt(e) || Yt(e) || t !== n && (ge(n) || "INPUT" === t.tagName || "TEXTAREA" === t.tagName || ge(I()) && I().contains(t)))
                        },
                        Rt = e => e.touches && e.touches.length && "stylus" === e.touches[0].touchType,
                        Yt = e => e.touches && e.touches.length > 1,
                        Xt = () => {
                            if (ee(document.body, k.iosfix)) {
                                const e = parseInt(document.body.style.top, 10);
                                ae(document.body, k.iosfix), document.body.style.top = "", document.body.scrollTop = -1 * e
                            }
                        },
                        Ut = 10,
                        Kt = e => {
                            ...
                            en(t, n, e), setTimeout((() => {
                                Jt(t, n)
                            }), Ut), U() && (Qt(t, e.scrollbarPadding, s), Tt()), K() || xe.previousActiveElement || (xe.previousActiveElement = document.activeElement), "function" == typeof e.didOpen && setTimeout((() => e.didOpen(n))), ae(t, k["no-transition"])
                        },
                        Zt = e => {
                            const t = L();
                            if (e.target !== t) return;
                            const n = O();
                            t.removeEventListener(De, Zt), n.style.overflowY = "auto"
                        },
                        Jt = (e, t) => {
                            De && ve(t) ? (e.style.overflowY = "hidden", t.addEventListener(De, Zt)) : e.style.overflowY = "auto"
                        },
                        Qt = (e, t, n) => {
                            Gt(), t && "hidden" !== n && Ht(), setTimeout((() => {
                                e.scrollTop = 0
                            }))
                        },
                        en = (e, t, n) => {
                            ...
                            }), Ut), oe([document.documentElement, document.body], k.shown), n.heightAuto && n.backdrop && !n.toast && oe([document.documentElement, document.body], k["height-auto"])
                        },
                        tn = e => {
                            let t = L();
                            t || new Ws, t = L();
                            const n = q();
                            K() ? ue(B()) : nn(t, e), de(n), t.setAttribute("data-loading", !0), t.setAttribute("aria-busy", !0), t.focus()
                        },
                        nn = (e, t) => {
                            const n = V(),
                                s = q();
                            !t && he(_()) && (t = _()), de(n), t && (ue(t), s.setAttribute("data-button-to-replace", t.className)), s.parentNode.insertBefore(s, t), oe([e, n], k.loading)
                        },
                        sn = (e, t) => {
                            "select" === t.input || "radio" === t.input ? cn(e, t) : ["text", "email", "number", "tel", "textarea"].includes(t.input) && (d(t.inputValue) || p(t.inputValue)) && (tn(_()), dn(e, t))
                        },
                        rn = (e, t) => {
                            const n = e.getInput();
                            if (!n) return null;
                        ...
                        cn = (e, t) => {
                            const n = L(),
                                s = e => un[t.input](n, pn(e), t);
                            d(t.inputOptions) || p(t.inputOptions) ? (tn(_()), u(t.inputOptions).then((t => {
                                e.hideLoading(), s(t)
                        ...
                        dn = (e, t) => {
                            const n = e.getInput();
                            ue(n), u(t.inputValue).then((s => {
                                n.value = "number" === t.input ? parseFloat(s) || 0 : "".concat(s), de(n), n.focus(), e.hideLoading()
                            })).catch((t => {
                                r("Error in inputValue promise: ".concat(t)), n.value = "", de(n), n.focus(), e.hideLoading()
                            }))
                        },
                        un = {
                            select: (e, t, n) => {
                                const s = le(e, k.select),
                                    i = (e, t, s) => {
                                        const i = document.createElement("option");
                                        i.value = s, Q(i, t), i.selected = mn(s, n.inputValue), e.appendChild(i)
                                    };
                                t.forEach((e => {
                                    const t = e[0],
                                        n = e[1];
                            ...
                            radio: (e, t, n) => {
                                const s = le(e, k.radio);
                                t.forEach((e => {
                                    const t = e[0],
                                        i = e[1],
                                        r = document.createElement("input"),
                                        o = document.createElement("label");
                                    r.type = "radio", r.name = k.radio, r.value = t, mn(t, n.inputValue) && (r.checked = !0);
                                    const a = document.createElement("span");
                                    Q(a, i), a.className = k.label, o.appendChild(r), o.appendChild(a), s.appendChild(o)
                                }));
                        ...
                        pn = e => {
                            ...
                            return "undefined" != typeof Map && e instanceof Map ? e.forEach(((e, n) => {
                                let s = e;
                                "object" == typeof s && (s = pn(s)), t.push([n, s])
                    ...
                    function hn() {
                        const e = Re.innerParams.get(this);
                        if (!e) return;
                        const t = Re.domCache.get(this);
                        ue(t.loader), K() ? e.icon && de(B()) : fn(t), ae([t.popup, t.actions], k.loading), t.popup.removeAttribute("aria-busy"), t.popup.removeAttribute("data-loading"), t.confirmButton.disabled = !1, t.denyButton.disabled = !1, t.cancelButton.disabled = !1
                    }
                    const fn = e => {
                        const t = e.popup.getElementsByClassName(e.loader.getAttribute("data-button-to-replace"));
                        t.length ? de(t[0], "inline-block") : fe() && ue(e.actions)
                    };

                    function gn(e) {
                        const t = Re.innerParams.get(e || this),
                            n = Re.domCache.get(e || this);
                    ...
                    function bn(e, t, n, s) {
                        K() ? On(e, s) : (Se(n).then((() => On(e, s))), xe.keydownTarget.removeEventListener("keydown", xe.keydownHandler, {
                            capture: xe.keydownListenerCapture
                        }), xe.keydownHandlerAdded = !1), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (t.setAttribute("style", "display:none !important"), t.removeAttribute("class"), t.innerHTML = "") : t.remove(), U() && (qt(), Xt(), St()), wn()
                    }

                    function wn() {
                        ae([document.documentElement, document.body], [k.shown, k["height-auto"], k["no-backdrop"], k["toast-shown"]])
                    }
                    ...
                    function yn(e) {
                        ...
                        const t = vn.swalPromiseResolve.get(this),
                            n = xn(this);
                        this.isAwaitingPromise() ? e.isDismissed || (Sn(this), t(e)) : n && t(e)
                    }

                    function Cn() {
                        return !!Re.awaitingPromise.get(this)
                    }
                    const xn = e => {
                        const t = L();
                        if (!t) return !1;
                        ...
                        const s = O();
                        return ae(s, n.showClass.backdrop), oe(s, n.hideClass.backdrop), kn(e, t, n), !0
                    };
                    ...
                    const Sn = e => {
                            e.isAwaitingPromise() && (Re.awaitingPromise.delete(e), Re.innerParams.get(e) || e._destroy())
                        },
                        En = e => void 0 === e ? {
                            isConfirmed: !1,
                            isDenied: !1,
                        ...
                        kn = (e, t, n) => {
                            const s = O(),
                                i = De && ve(t);
                            "function" == typeof n.willClose && n.willClose(t), i ? Pn(e, t, s, n.returnFocus, n.didClose) : bn(e, s, n.returnFocus, n.didClose)
                        },
                        Pn = (e, t, n, s, i) => {
                            xe.swalCloseEventFinishedCallback = bn.bind(null, e, n, s, i), t.addEventListener(De, (function(e) {
                                e.target === t && (xe.swalCloseEventFinishedCallback(), delete xe.swalCloseEventFinishedCallback)
                            }))
                        },
                        On = (e, t) => {
                            setTimeout((() => {
                    ...
                    function jn(e) {
                        const t = Re.domCache.get(this),
                            n = Re.innerParams.get(this);
                        Q(t.validationMessage, e), t.validationMessage.className = k["validation-message"], n.customClass && n.customClass.validationMessage && oe(t.validationMessage, n.customClass.validationMessage), de(t.validationMessage);
                        const s = this.getInput();
                        s && (s.setAttribute("aria-invalid", !0), s.setAttribute("aria-describedby", k["validation-message"]), ie(s), oe(s, k.inputerror))
                    }

                    function Dn() {
                        const e = Re.domCache.get(this);
                        e.validationMessage && ue(e.validationMessage);
                        const t = this.getInput();
                        t && (t.removeAttribute("aria-invalid"), t.removeAttribute("aria-describedby"), ae(t, k.inputerror))
                    }

                    function zn() {
                        return Re.domCache.get(this).progressSteps
                    }

                    function _n(e) {
                        const t = L(),
                            n = Re.innerParams.get(this);
                        if (!t || ee(t, n.hideClass.popup)) return i("You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup.");
                        const s = Nn(e),
                            r = Object.assign({}, n, s);
                        Ct(this, r), Re.innerParams.set(this, r), Object.defineProperties(this, {
                            params: {
                    ...
                    const Nn = e => {
                        ...
                        return Object.keys(e).forEach((n => {
                            b(n) ? t[n] = e[n] : i('Invalid parameter to update: "'.concat(n, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js\n\nIf you think this parameter should be updatable, request it here: https://github.com/sweetalert2/sweetalert2/issues/new?template=02_feature_request.md'))
                        })), t
                    };

                    function Hn() {
                        const e = Re.domCache.get(this),
                            t = Re.innerParams.get(this);
                        t ? (e.popup && xe.swalCloseEventFinishedCallback && (xe.swalCloseEventFinishedCallback(), delete xe.swalCloseEventFinishedCallback), xe.deferDisposalTimer && (clearTimeout(xe.deferDisposalTimer), delete xe.deferDisposalTimer), "function" == typeof t.didDestroy && t.didDestroy(), qn(this)) : Gn(this)
                    }
                    const qn = e => {
                            Gn(e), delete e.params, delete xe.keydownHandler, delete xe.keydownTarget, delete xe.currentInstance
                        },
                        Gn = e => {
                            e.isAwaitingPromise() ? (Vn(Re, e), Re.awaitingPromise.set(e, !0)) : (Vn(vn, e), Vn(Re, e))
                        },
                        Vn = (e, t) => {
                    ...
                    var Fn = Object.freeze({
                        ...
                        resetValidationMessage: Dn,
                        getProgressSteps: zn,
                        update: _n,
                        _destroy: Hn
                    });
                    const Wn = e => {
                            const t = Re.innerParams.get(e);
                            e.disableButtons(), t.input ? Xn(e, "confirm") : Qn(e, !0)
                        },
                        Rn = e => {
                            const t = Re.innerParams.get(e);
                            e.disableButtons(), t.returnInputValueOnDeny ? Xn(e, "deny") : Kn(e, !1)
                        },
                        Yn = (e, t) => {
                            e.disableButtons(), t(xt.cancel)
                        },
                        Xn = (e, t) => {
                            const s = Re.innerParams.get(e);
                            if (!s.input) return r('The "input" parameter is needed to be set when using returnInputValueOn'.concat(n(t)));
                            const i = rn(e, s);
                            s.inputValidator ? Un(e, i, t) : e.getInput().checkValidity() ? "deny" === t ? Kn(e, i) : Qn(e, i) : (e.enableButtons(), e.showValidationMessage(s.validationMessage))
                        },
                        Un = (e, t, n) => {
                            const s = Re.innerParams.get(e);
                            e.disableInput(), Promise.resolve().then((() => u(s.inputValidator(t, s.validationMessage)))).then((s => {
                                e.enableButtons(), e.enableInput(), s ? e.showValidationMessage(s) : "deny" === n ? Kn(e, t) : Qn(e, t)
                            }))
                        },
                        Kn = (e, t) => {
                            const n = Re.innerParams.get(e || void 0);
                            n.showLoaderOnDeny && tn(N()), n.preDeny ? (Re.awaitingPromise.set(e || void 0, !0), Promise.resolve().then((() => u(n.preDeny(t, n.validationMessage)))).then((n => {
                                !1 === n ? (e.hideLoading(), Sn(e)) : e.closePopup({
                                    isDenied: !0,
                                    value: void 0 === n ? t : n
                                })
                            })).catch((t => Jn(e || void 0, t)))) : e.closePopup({
                                isDenied: !0,
                                value: t
                            })
                        },
                        ...
                        Qn = (e, t) => {
                            const n = Re.innerParams.get(e || void 0);
                            n.showLoaderOnConfirm && tn(), n.preConfirm ? (e.resetValidationMessage(), Re.awaitingPromise.set(e || void 0, !0), Promise.resolve().then((() => u(n.preConfirm(t, n.validationMessage)))).then((n => {
                                he(z()) || !1 === n ? (e.hideLoading(), Sn(e)) : Zn(e, void 0 === n ? t : n)
                            })).catch((t => Jn(e || void 0, t)))) : Zn(e, t)
                        },
                        es = (e, t, n) => {
                            Re.innerParams.get(e).toast ? ts(e, t, n) : (is(t), rs(t), os(e, t, n))
                        },
                        ts = (e, t, n) => {
                            t.popup.onclick = () => {
                                const t = Re.innerParams.get(e);
                                t && (ns(t) || t.timer || t.input) || n(xt.close)
                            }
                        },
                        ns = e => e.showConfirmButton || e.showDenyButton || e.showCancelButton || e.showCloseButton;
                    let ss = !1;
                    const is = e => {
                            e.popup.onmousedown = () => {
                                e.container.onmouseup = function(t) {
                                    e.container.onmouseup = void 0, t.target === e.container && (ss = !0)
                                }
                            }
                        },
                        rs = e => {
                            e.container.onmousedown = () => {
                                e.popup.onmouseup = function(t) {
                                    e.popup.onmouseup = void 0, (t.target === e.popup || e.popup.contains(t.target)) && (ss = !0)
                                }
                            }
                        },
                        os = (e, t, n) => {
                            t.container.onclick = s => {
                                const i = Re.innerParams.get(e);
                                ss ? ss = !1 : s.target === t.container && c(i.allowOutsideClick) && n(xt.backdrop)
                            }
                        },
                        as = () => he(L()),
                        ls = () => _() && _().click(),
                        ...
                        us = (e, t, n, s) => {
                            ...
                            }), t.keydownHandlerAdded = !1), n.toast || (t.keydownHandler = t => fs(e, t, s), t.keydownTarget = n.keydownListenerCapture ? window : L(), t.keydownListenerCapture = n.keydownListenerCapture, t.keydownTarget.addEventListener("keydown", t.keydownHandler, {
                                capture: t.keydownListenerCapture
                        ...
                        ms = ["ArrowRight", "ArrowDown"],
                        hs = ["ArrowLeft", "ArrowUp"],
                        fs = (e, t, n) => {
                            const s = Re.innerParams.get(e);
                            s && (t.isComposing || 229 === t.keyCode || (s.stopKeydownPropagation && t.stopPropagation(), "Enter" === t.key ? gs(e, t, s) : "Tab" === t.key ? vs(t, s) : [...ms, ...hs].includes(t.key) ? bs(t.key) : "Escape" === t.key && ws(t, s, n)))
                        },
                        gs = (e, t, n) => {
                        ...
                        vs = (e, t) => {
                            ...
                            for (let e = 0; e < s.length; e++)
                                if (n === s[e]) {
                                    i = e;
                                    break
                                } e.shiftKey ? ps(t, i, -1) : ps(t, i, 1), e.stopPropagation(), e.preventDefault()
                        },
                        bs = e => {
                            if (![_(), N(), G()].includes(document.activeElement)) return;
                            const t = ms.includes(e) ? "nextElementSibling" : "previousElementSibling";
                            let n = document.activeElement;
                            for (let e = 0; e < V().children.length; e++) {
                                if (n = n[t], !n) return;
                                if (he(n) && n instanceof HTMLButtonElement) break
                            }
                            n instanceof HTMLButtonElement && n.focus()
                        },
                        ws = (e, t, n) => {
                            c(t.allowEscapeKey) && (e.preventDefault(), n(xt.esc))
                        },
                        ys = e => "object" == typeof e && e.jquery,
                        Cs = e => e instanceof Element || ys(e),
                        xs = e => {
                            const t = {};
                            return "object" != typeof e[0] || Cs(e[0]) ? ["title", "html", "icon"].forEach(((n, s) => {
                                const i = e[s];
                                "string" == typeof i || Cs(i) ? t[n] = i : void 0 !== i && r("Unexpected type of ".concat(n, '! Expected "string" or "Element", got ').concat(typeof i))
                    ...
                    const Es = () => xe.timeout && xe.timeout.getTimerLeft(),
                        ks = () => {
                            if (xe.timeout) return we(), xe.timeout.stop()
                        },
                        Ps = () => {
                            if (xe.timeout) {
                                const e = xe.timeout.start();
                                return be(e), e
                            }
                        },
                        Os = () => {
                            const e = xe.timeout;
                            return e && (e.running ? ks() : Ps())
                        },
                        As = e => {
                            if (xe.timeout) {
                                const t = xe.timeout.increase(e);
                                return be(t, !0), t
                            }
                        },
                        Ms = () => xe.timeout && xe.timeout.isRunning();
                    let Ls = !1;
                    const Bs = {};

                    function $s() {
                        Bs[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "data-swal-template"] = this, Ls || (document.body.addEventListener("click", Is), Ls = !0)
                    }
                    const Is = e => {
                        for (let t = e.target; t && t !== document; t = t.parentNode)
                            for (const e in Bs) {
                                const n = t.getAttribute(e);
                                if (n) return void Bs[e].fire({
                                    template: n
                                })
                            }
                    };
                    ...
                    class zs {
                        constructor() {
                            ...
                            Re.promise.set(this, i)
                        }
                        _main(e) {
                            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                            T(Object.assign({}, t, e)), xe.currentInstance && (xe.currentInstance._destroy(), U() && St()), xe.currentInstance = this;
                            const n = Ns(e, t);
                            _t(n), Object.freeze(n), xe.timeout && (xe.timeout.stop(), delete xe.timeout), clearTimeout(xe.restoreFocusTimeout);
                            const s = Hs(this);
                            return Ct(this, n), Re.innerParams.set(this, n), _s(this, s, n)
                        }
                        then(e) {
                            return Re.promise.get(this).then(e)
                        } finally(e) {
                            return Re.promise.get(this).finally(e)
                        }
                    }
                    const _s = (e, t, n) => new Promise(((s, i) => {
                            const r = t => {
                                e.closePopup({
                                    isDismissed: !0,
                                    dismiss: t
                            ...
                            vn.swalPromiseResolve.set(e, s), vn.swalPromiseReject.set(e, i), t.confirmButton.onclick = () => Wn(e), t.denyButton.onclick = () => Rn(e), t.cancelButton.onclick = () => Yn(e, r), t.closeButton.onclick = () => r(xt.close), es(e, t, r), us(e, xe, n, r), sn(e, n), Kt(n), qs(xe, n, r), Gs(t, n), setTimeout((() => {
                                t.container.scrollTop = 0
                            }))
                        })),
                        Ns = (e, t) => {
                            const n = kt(e),
                                s = Object.assign({}, m, t, n, e);
                            return s.showClass = Object.assign({}, m.showClass, s.showClass), s.hideClass = Object.assign({}, m.hideClass, s.hideClass), s
                        },
                        Hs = e => {
                            const t = {
                                popup: L(),
                            ...
                            return Re.domCache.set(e, t), t
                        },
                        qs = (e, t, n) => {
                            const s = W();
                            ue(s), t.timer && (e.timeout = new Nt((() => {
                                n("timer"), delete e.timeout
                            }), t.timer), t.timerProgressBar && (de(s), ne(s, t, "timerProgressBar"), setTimeout((() => {
                                e.timeout && e.timeout.running && be(t.timer)
                            }))))
                        },
                        Gs = (e, t) => {
                            if (!t.toast) return c(t.allowEnterKey) ? void(Vs(e, t) || ps(t, -1, 1)) : Fs()
                        },
                        Vs = (e, t) => t.focusDeny && he(e.denyButton) ? (e.denyButton.focus(), !0) : t.focusCancel && he(e.cancelButton) ? (e.cancelButton.focus(), !0) : !(!t.focusConfirm || !he(e.confirmButton) || (e.confirmButton.focus(), 0)),
                        Fs = () => {
                            document.activeElement instanceof HTMLElement && "function" == typeof document.activeElement.blur && document.activeElement.blur()
                        };
                    Object.assign(zs.prototype, Fn), Object.assign(zs, js), Object.keys(Fn).forEach((e => {
                        zs[e] = function() {
                            if (Ds) return Ds[e](...arguments)
                        }
                    })), zs.DismissReason = xt, zs.version = "11.4.4";
                    const Ws = zs;
    ...
    n.n = e => {
        ...
        function s(e = {}, n = {}) {
            Object.keys(n).forEach((i => {
                void 0 === e[i] ? e[i] = n[i] : t(n[i]) && t(e[i]) && Object.keys(n[i]).length > 0 && s(e[i], n[i])
            }))
        }
        const i = {
            body: {},
        ...
        const h = {
            ...
            on: function(...e) {
                ...
                function r(e) {
                    ...
                    if (i.indexOf(e) < 0 && i.unshift(e), u(t).is(n)) s.apply(t, i);
                    else {
                        const e = u(t).parents();
                        for (let t = 0; t < e.length; t += 1) u(e[t]).is(n) && s.apply(e[t], i)
                    }
                }
            ...
            parents: function(e) {
                ...
                for (let n = 0; n < this.length; n += 1) {
                    ...
                    for (; s;) e ? u(s).is(e) && t.push(s) : t.push(s), s = s.parentNode
                }
                return u(t)
            },
            closest: function(e) {
            ...
            children: function(e) {
                ...
                for (let n = 0; n < this.length; n += 1) {
                    ...
                    for (let n = 0; n < s.length; n += 1) e && !u(s[n]).is(e) || t.push(s[n])
                }
                return u(t)
            },
            filter: function(e) {
            ...
            for (let i = 1; i < e.length; i += 1) {
                ...
                if (null != r && (s = r, !("undefined" != typeof window && void 0 !== window.HTMLElement ? s instanceof HTMLElement : s && (1 === s.nodeType || 11 === s.nodeType)))) {
                    ...
                    for (let n = 0, s = e.length; n < s; n += 1) {
                        ...
                        void 0 !== i && i.enumerable && (w(t[s]) && w(r[s]) ? r[s].__swiper__ ? t[s] = r[s] : y(t[s], r[s]) : !w(t[s]) && w(r[s]) ? (t[s] = {}, r[s].__swiper__ ? t[s] = r[s] : y(t[s], r[s])) : t[s] = r[s])
                    }
                }
            }
            var s;
        ...
        function P(e = {}) {
            return S || (S = function({
                ...
                const u = i.match(/(iPod)(.*OS\s([\d_]+))?/),
                    ...
                    m = "Win32" === s;
                let h = "MacIntel" === s;
                return !d && h && t.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${o}x${l}`) >= 0 && (d = i.match(/(Version)\/([\d.]+)/), d || (d = [0, 1, "13_0_0"]), h = !1), c && !m && (r.os = "android", r.android = !0), (d || p || u) && (r.os = "ios", r.ios = !0), r
            }(e)), S
        }
        ...
        const M = {
            ...
            updateSlides: function() {
                ...
                for (let i = 0; i < u; i += 1) {
                    E = 0;
                    const o = d.eq(i);
                    if (S && e.grid.updateSlide(i, o, u, t), "none" !== o.css("display")) {
                        ...
                        d[i] && (d[i].swiperSlideSize = E), h.push(E), s.centeredSlides ? (y = y + E / 2 + x / 2 + w, 0 === x && 0 !== i && (y = y - r / 2 - w), 0 === i && (y = y - r / 2 - w), Math.abs(y) < .001 && (y = 0), s.roundLengths && (y = Math.floor(y)), T % s.slidesPerGroup == 0 && p.push(y), m.push(y)) : (s.roundLengths && (y = Math.floor(y)), (T - Math.min(e.params.slidesPerGroupSkip, T)) % e.params.slidesPerGroup == 0 && p.push(y), m.push(y), y = y + E + w), e.virtualSize += E + w, x = E, T += 1
                    }
                }
                if (e.virtualSize = Math.max(e.virtualSize, r) + g, o && a && ("slide" === s.effect || "coverflow" === s.effect) && i.css({
                    ...
                    }), S && e.grid.updateWrapperSize(E, p, t), !s.centeredSlides) {
                    const t = [];
                ...
                u !== c && e.emit("slidesLengthChange"), p.length !== v && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), m.length !== b && e.emit("slidesGridLengthChange"), s.watchSlidesProgress && e.updateSlidesOffset()
            },
            ...
            updateClickedSlide: function(e) {
                ...
                t.clickedSlide = s, t.virtual && t.params.virtual.enabled ? t.clickedIndex = parseInt(f(s).attr("data-swiper-slide-index"), 10) : t.clickedIndex = i, n.slideToClickedSlide && void 0 !== t.clickedIndex && t.clickedIndex !== t.activeIndex && t.slideToClickedSlide()
            }
        };
        const L = {
        ...
        const $ = {
            slideTo: function(e = 0, t = this.params.speed, n = !0, s, i) {
                ...
                if (r.animating && a.preventInteractionOnTransition || !h && !s && !i) return !1;
            ...
            slidePrev: function(e = this.params.speed, t = !0, n) {
                ...
                let h = 0;
                return void 0 !== m && (h = a.indexOf(m), h < 0 && (h = s.activeIndex - 1), "auto" === i.slidesPerView && 1 === i.slidesPerGroup && i.slidesPerGroupAuto && (h = h - s.slidesPerViewDynamic("previous", !0) + 1, h = Math.max(h, 0))), i.rewind && s.isBeginning ? s.slideTo(s.slides.length - 1, e, t, n) : s.slideTo(h, e, t, n)
            },
            ...
            slideToClickedSlide: function() {
                ...
                if (t.loop) {
                    ...
                    i = parseInt(f(e.clickedSlide).attr("data-swiper-slide-index"), 10), t.centeredSlides ? r < e.loopedSlides - s / 2 || r > e.slides.length - e.loopedSlides + s / 2 ? (e.loopFix(), r = n.children(`.${t.slideClass}[data-swiper-slide-index="${i}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), g((() => {
                        e.slideTo(r)
                    }))) : e.slideTo(r) : r > e.slides.length - s ? (e.loopFix(), r = n.children(`.${t.slideClass}[data-swiper-slide-index="${i}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), g((() => {
                        e.slideTo(r)
                    }))) : e.slideTo(r)
                } else e.slideTo(r)
            }
        ...
        const I = {
            loopCreate: function() {
                const e = this,
                    ...
                    i = s.children().length > 0 ? f(s.children()[0].parentNode) : s;
                ...
                o.each(((t, n) => {
                    const s = f(t);
                    n < e.loopedSlides && l.push(t), n < o.length && n >= o.length - e.loopedSlides && a.push(t), s.attr("data-swiper-slide-index", n)
                }));
                for (let e = 0; e < l.length; e += 1) i.append(f(l[e].cloneNode(!0)).addClass(n.slideDuplicateClass));
                for (let e = a.length - 1; e >= 0; e -= 1) i.prepend(f(a[e].cloneNode(!0)).addClass(n.slideDuplicateClass))
            },
            loopFix: function() {
                const e = this;
        ...
        function j(e) {
            ...
            if (Object.assign(i, {
                    ...
                    isScrolling: void 0,
                    startMoving: void 0
                }), l.startX = h, l.startY = g, i.touchStartTime = v(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, o.threshold > 0 && (i.allowThresholdMove = !1), "touchstart" !== d.type) {
                let e = !0;
                u.is(i.focusableElements) && (e = !1), n.activeElement && f(n.activeElement).is(i.focusableElements) && n.activeElement !== u[0] && n.activeElement.blur();
                const s = e && t.allowTouchMove && o.touchStartPreventDefault;
                !o.touchStartForcePreventDefault && !s || u[0].isContentEditable || d.preventDefault()
            }
            t.emit("touchStart", d)
        }
        ...
        function D(e) {
            ...
            if (!n.allowTouchMove) return n.allowClick = !1, void(s.isTouched && (Object.assign(o, {
                startX: u,
                startY: p,
                currentX: u,
                currentY: p
            ...
            if (s.isTouchEvent && i.touchReleaseOnEdges && !i.loop)
                if (n.isVertical()) {
                    if (p < o.startY && n.translate <= n.maxTranslate() || p > o.startY && n.translate >= n.minTranslate()) return s.isTouched = !1, void(s.isMoved = !1)
                } else if (u < o.startX && n.translate <= n.maxTranslate() || u > o.startX && n.translate >= n.minTranslate()) return;
            if (s.isTouchEvent && t.activeElement && c.target === t.activeElement && f(c.target).is(s.focusableElements)) return s.isMoved = !0, void(n.allowClick = !1);
            ...
            if (void 0 === s.isScrolling) {
                let e;
                n.isHorizontal() && o.currentY === o.startY || n.isVertical() && o.currentX === o.startX ? s.isScrolling = !1 : m * m + h * h >= 25 && (e = 180 * Math.atan2(Math.abs(h), Math.abs(m)) / Math.PI, s.isScrolling = n.isHorizontal() ? e > i.touchAngle : 90 - e > i.touchAngle)
            }
            ...
            let g = n.isHorizontal() ? m : h;
            o.diff = g, g *= i.touchRatio, a && (g = -g), n.swipeDirection = g > 0 ? "prev" : "next", s.currentTranslate = g + s.startTranslate;
            let b = !0,
                w = i.resistanceRatio;
            if (i.touchReleaseOnEdges && (w = 0), g > 0 && s.currentTranslate > n.minTranslate() ? (b = !1, i.resistance && (s.currentTranslate = n.minTranslate() - 1 + (-n.minTranslate() + s.startTranslate + g) ** w)) : g < 0 && s.currentTranslate < n.maxTranslate() && (b = !1, i.resistance && (s.currentTranslate = n.maxTranslate() + 1 - (n.maxTranslate() - s.startTranslate - g) ** w)), b && (c.preventedByNestedSwiper = !0), !n.allowSlideNext && "next" === n.swipeDirection && s.currentTranslate < s.startTranslate && (s.currentTranslate = s.startTranslate), !n.allowSlidePrev && "prev" === n.swipeDirection && s.currentTranslate > s.startTranslate && (s.currentTranslate = s.startTranslate), n.allowSlidePrev || n.allowSlideNext || (s.currentTranslate = s.startTranslate), i.threshold > 0) {
        ...
        function z(e) {
            ...
            const h = (u - o[p]) / m,
                f = p < s.slidesPerGroupSkip - 1 ? 1 : s.slidesPerGroup;
            if (d > s.longSwipesMs) {
                if (!s.longSwipes) return void t.slideTo(t.activeIndex);
                "next" === t.swipeDirection && (h >= s.longSwipesRatio ? t.slideTo(p + f) : t.slideTo(p)), "prev" === t.swipeDirection && (h > 1 - s.longSwipesRatio ? t.slideTo(p + f) : t.slideTo(p))
            } else {
                if (!s.shortSwipes) return void t.slideTo(t.activeIndex);
                t.navigation && (l.target === t.navigation.nextEl || l.target === t.navigation.prevEl) ? l.target === t.navigation.nextEl ? t.slideTo(p + f) : t.slideTo(p) : ("next" === t.swipeDirection && t.slideTo(p + f), "prev" === t.swipeDirection && t.slideTo(p))
            }
        }
        ...
        const V = (e, t) => {
            ...
            if (c.touch) {
                ...
                o[u](i.start, e.onTouchStart, t), o[u](i.move, e.onTouchMove, c.passiveListener ? {
                    passive: !1,
                    capture: d
                } : d), o[u](i.end, e.onTouchEnd, t), i.cancel && o[u](i.cancel, e.onTouchEnd, t)
            } else o[u](i.start, e.onTouchStart, !1), n[u](i.move, e.onTouchMove, d), n[u](i.end, e.onTouchEnd, !1);
            (s.preventClicks || s.preventClicksPropagation) && o[u]("click", e.onClick, !0), s.cssMode && a[u]("scroll", e.onScroll), s.updateOnWindowResize ? e[p](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", _, !0) : e[p]("observerUpdate", _, !0)
        };
        const F = {
                attachEvents: function() {
                    ...
                    e.onTouchStart = j.bind(e), e.onTouchMove = D.bind(e), e.onTouchEnd = z.bind(e), n.cssMode && (e.onScroll = H.bind(e)), e.onClick = N.bind(e), s.touch && !q && (t.addEventListener("touchstart", G), q = !0), V(e, "on")
                },
        ...
        const R = {
            setBreakpoint: function() {
                ...
                }), u && !h ? e.disable() : !u && h && e.enable(), e.currentBreakpoint = a, e.emit("_beforeBreakpoint", l), m && n && (e.loopDestroy(), e.loopCreate(), e.updateSlides(), e.slideTo(t - s + e.loopedSlides, 0, !1)), e.emit("breakpoint", l)
            },
        ...
        const K = {
                ...
                transition: {
                    ...
                    transitionStart: function(e = !0, t) {
                        ...
                        s.cssMode || (s.autoHeight && n.updateAutoHeight(), B({
                            swiper: n,
                            runCallbacks: e,
                            direction: t,
                            step: "Start"
                    ...
                    transitionEnd: function(e = !0, t) {
                        ...
                        n.animating = !1, s.cssMode || (n.setTransition(0), B({
                            swiper: n,
                            runCallbacks: e,
                            direction: t,
                            step: "End"
                ...
                images: {
                    loadImage: function(e, t, n, s, i, r) {
                        ...
                        f(e).parent("picture")[0] || e.complete && i ? c() : t ? (l = new o.Image, l.onload = c, l.onerror = c, s && (l.sizes = s), n && (l.srcset = n), t && (l.src = t)) : c()
                    },
        ...
        class J {
            constructor(...e) {
                ...
                const s = this;
                s.__swiper__ = !0, s.support = k(), s.device = P({
                    userAgent: n.userAgent
                }), s.browser = O(), s.eventsListeners = {}, s.eventsAnyListeners = [], s.modules = [...s.__modules__], n.modules && Array.isArray(n.modules) && s.modules.push(...n.modules);
                const i = {};
                s.modules.forEach((e => {
                    e({
                        swiper: s,
                ...
                const r = y({}, X, i);
                return s.params = y({}, r, Z, n), s.originalParams = y({}, s.params), s.passedParams = y({}, n), s.params && s.params.on && Object.keys(s.params.on).forEach((e => {
                    s.on(e, s.params.on[e])
                })), s.params && s.params.onAny && s.onAny(s.params.onAny), s.$ = f, Object.assign(s, {
            ...
            mount(e) {
                ...
                let i = (() => {
                    if (e && e.shadowRoot && e.shadowRoot.querySelector) {
                        const t = f(e.shadowRoot.querySelector(s()));
                ...
                if (0 === i.length && t.params.createElements) {
                    ...
                    i = f(e), e.className = t.params.wrapperClass, n.append(e), n.children(`.${t.params.slideClass}`).each((e => {
                        i.append(e)
                    }))
                }
        ...
        function ie(t, n) {
            if (document.querySelector(t)) new Q(t, function(t) {
                for (var n = 1; n < arguments.length; n++) {
                    var s = null != arguments[n] ? arguments[n] : {};
                    n % 2 ? se(Object(s), !0).forEach((function(n) {
                        e(t, n, s[n])
                    })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(s)) : se(Object(s)).forEach((function(e) {
        ...
        Q.use([function({
            ...
            t({
                ...
                if (e.params.navigation.hideOnClick && !f(o).is(r) && !f(o).is(i)) {
            ...
            function c() {
                ...
                if ("fraction" === n.type && (c.find(te(n.currentClass)).text(n.formatFractionCurrent(d + 1)), c.find(te(n.totalClass)).text(n.formatFractionTotal(u))), "progressbar" === n.type) {
                    let t;
                    t = n.progressbarOpposite ? e.isHorizontal() ? "vertical" : "horizontal" : e.isHorizontal() ? "horizontal" : "vertical";
                    const s = (d + 1) / u;
                    let i = 1,
                        r = 1;
                    "horizontal" === t ? i = s : r = s, c.find(te(n.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${i}) scaleY(${r})`).transition(e.params.speed)
                }
            ...
            function d() {
                ...
                if ("bullets" === t.type) {
                    ...
                    i.html(r), e.pagination.bullets = i.find(te(t.bulletClass))
                }
            ...
            function p() {
                ...
                n.removeClass(t.hiddenClass), n.removeClass(t.modifierClass + t.type), n.removeClass(t.modifierClass + e.params.direction), e.pagination.bullets && e.pagination.bullets.removeClass && e.pagination.bullets.removeClass(t.bulletActiveClass), t.clickable && n.off("click", te(t.bulletClass))
            }
            n("init", (() => {
                u(), d(), c()
            })), n("activeIndexChange", (() => {
                ...
                if (e.params.pagination.el && e.params.pagination.hideOnClick && r.length > 0 && !f(i).hasClass(e.params.pagination.bulletClass)) {
            ...
            function o() {
                ...
                t.attr("data-swiper-autoplay") && (n = t.attr("data-swiper-autoplay") || e.params.autoplay.delay), clearTimeout(i), i = g((() => {
                    let t;
                    e.params.autoplay.reverseDirection ? e.params.loop ? (e.loopFix(), t = e.slidePrev(e.params.speed, !0, !0), s("autoplay")) : e.isBeginning ? e.params.autoplay.stopOnLastSlide ? l() : (t = e.slideTo(e.slides.length - 1, e.params.speed, !0, !0), s("autoplay")) : (t = e.slidePrev(e.params.speed, !0, !0), s("autoplay")) : e.params.loop ? (e.loopFix(), t = e.slideNext(e.params.speed, !0, !0), s("autoplay")) : e.isEnd ? e.params.autoplay.stopOnLastSlide ? l() : (t = e.slideTo(0, e.params.speed, !0, !0), s("autoplay")) : (t = e.slideNext(e.params.speed, !0, !0), s("autoplay")), (e.params.cssMode && e.autoplay.running || !1 === t) && o()
                }), n)
            }

            function a() {
                return void 0 === i && (!e.autoplay.running && (e.autoplay.running = !0, s("autoplayStart"), o(), !0))
            }
            ...
            e.autoplay = {
                ...
                if (e.params.autoplay.enabled) {
                    a();
                    r().addEventListener("visibilitychange", d), e.params.autoplay.pauseOnMouseEnter && (e.$el.on("mouseenter", p), e.$el.on("mouseleave", m))
                }
                ...
                e.$el.off("mouseenter", p), e.$el.off("mouseleave", m), e.autoplay.running && l();
            ...
            function r() {
                ...
                const n = t.clickedIndex,
                    s = t.clickedSlide;
                if (s && f(s).hasClass(e.params.thumbs.slideThumbActiveClass)) return;
                if (null == n) return;
                let i;
            ...
            function a(t) {
                ...
                if (e.realIndex !== n.realIndex || r) {
                    ...
                    if (n.params.loop) {
                        ...
                        o = void 0 === t ? s : void 0 === s ? t : s - l == l - t ? n.params.slidesPerGroup > 1 ? s : l : s - l < l - t ? s : t, a = e.activeIndex > e.previousIndex ? "next" : "prev"
                    } else o = e.realIndex, a = o > e.previousIndex ? "next" : "prev";
                    r && (o += "next" === a ? i : -1 * i), n.visibleSlidesIndexes && n.visibleSlidesIndexes.indexOf(o) < 0 && (n.params.centeredSlides ? o = o > l ? o - Math.floor(s / 2) + 1 : o + Math.floor(s / 2) - 1 : o > l && n.params.slidesPerGroup, n.slideTo(o, t ? 0 : void 0))
                }
                let o = 1;
                const a = e.params.thumbs.slideThumbActiveClass;
                if (e.params.slidesPerView > 1 && !e.params.centeredSlides && (o = e.params.slidesPerView), e.params.thumbs.multipleActiveThumbs || (o = 1), o = Math.floor(o), n.slides.removeClass(a), n.params.loop || n.params.virtual && n.params.virtual.enabled)
                    for (let t = 0; t < o; t += 1) n.$wrapperEl.children(`[data-swiper-slide-index="${e.realIndex+t}"]`).addClass(a);
                else
                    for (let t = 0; t < o; t += 1) n.slides.eq(e.realIndex + t).addClass(a)
            }
            e.thumbs = {
                swiper: null
            }, n("beforeInit", (() => {
        ...
        const le = function(t, n) {
            oe().fire(function(t) {
                for (var n = 1; n < arguments.length; n++) {
                    var s = null != arguments[n] ? arguments[n] : {};
                    n % 2 ? ae(Object(s), !0).forEach((function(n) {
                        e(t, n, s[n])
        ...
        const ce = function(e, t) {
            ...
            document.querySelector(e) && function(e, t) {
                var s = document.querySelector(e),
                    i = s.querySelector("#days"),
                    r = s.querySelector("#hours"),
                    o = s.querySelector("#minutes"),
                    a = s.querySelector("#seconds"),
                    l = setInterval(c, 1e3);
                ...
                function c() {
                    ...
                    i && (i.textContent = n(e.days)), r.textContent = n(e.hours), o.textContent = n(e.minutes), a.textContent = n(e.seconds), e.total <= 0 && (i.textContent = "00", r.textContent = "00", o.textContent = "00", a.textContent = "00", clearInterval(l))
                }
                c()
            }(e, t)
        };
        ...
        function ue(t) {
            for (var n = 1; n < arguments.length; n++) {
                var s = null != arguments[n] ? arguments[n] : {};
                n % 2 ? de(Object(s), !0).forEach((function(n) {
                    e(t, n, s[n])
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ie(".reviews_slider--media", ue(ue({}, me), {}, {
                watchSlidesProgress: !0
            })), ie(".reviews_slider--main", ue(ue({}, me), {}, {
